...
export function WorldView({ worlds, onWorldSelect, currentWorld }: WorldViewProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-github-darker rounded-lg p-4 border border-github-border">
            ...
            <div key={world?.id || `empty-${index}`} className="flex flex-col items-center gap-3 group">
              <button
                ...
                className={`
                  ...
                  ${world?.isUnlocked 
                    ? 'bg-github-darker hover:bg-white cursor-pointer border-2 border-github-border hover:border-github-accent' 
                    : 'bg-github-darker cursor-not-allowed border-2 border-github-border opacity-50'}
